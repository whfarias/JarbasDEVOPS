...
do
    ...
    echo $segment | curl -X POST -d @- --user admin:pasTeur?mi --header "Content-Type:application/json" https://mobiledemodevopsed-server.eu-gb.mybluemix.net/mfpadmin/management-apis/2.0/runtimes/mfp/admin-plugins/liveUpdateAdapter/com.ibm.codebakery.jarbas/segment
    ((counter++))
done